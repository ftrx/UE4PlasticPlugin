...
private:
	...
	void UnloadPackagesSyncAndReloadMap();
	FString UnloadPackagesAndMap(const TArray<FString>& InPackageNames);
	void ReloadMap(const FString& InWorldPackageFilenameToReload);
